Public Class EmployeeBorrowEquipment
    Private Sub EmployeeBorrowEquipment_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub EmployeeBorrowEquipment_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
